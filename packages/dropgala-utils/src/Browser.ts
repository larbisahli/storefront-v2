...
export const toggleScroll = (state: boolean): boolean =>
  document.documentElement.classList.toggle('scrollDisabled', !state)

export const isScrollDisabled = (): boolean =>
